$(function() {
    ...
    $.getJSON("./voice-token?clientid=" + $('#issueid').val())
      .then(function(data) {
        log("Got a token.");
    ...
    document.getElementById("button-call").onclick = function() {
      ...
      // const formatedNumber = document.getElementById("to-phone-number").value.replace("0", "+61");

      const formatedNumber = document.getElementById("phone-number").value;
